...
class OBJ_DPTHead(nn.Module):
    ...
    def __init__(
        ...
        super(OBJ_DPTHead, self).__init__()
    ...
    def _forward_impl(
        ...
        for layer_idx in self.intermediate_layer_idx:
            ...
            if object_latent is not None and self.object_latent_proj is not None:
                latent = object_latent
                if frames_start_idx is not None and frames_end_idx is not None:
                    latent = latent[:, frames_start_idx:frames_end_idx]
                x = x + self.object_latent_proj(latent).unsqueeze(2)
